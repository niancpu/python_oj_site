...
const CreativeWelcomePage: React.FC<WelcomePageProps> = ({ onStart }) => {
  ...
  return (
    <div style={{ position: 'relative', width: '100vw', height: '100vh', overflow: 'hidden' }}>
      <canvas ref={canvasRef} style={{ position: 'absolute', top: 0, left: 0, zIndex: 0, background: 'linear-gradient(to bottom, #ffffff 0%, #f1f3f4 100%)' }} />
      <div style={{
        position: 'relative',
        zIndex: 1,
        height: '100%',
        ...
        <h1 style={{
          ...
          letterSpacing: '-2px',
          marginBottom: '10px',
          background: 'linear-gradient(45deg, #4285F4, #2b6ed4)',
        ...
        <p style={{
          ...
          Your personal space to practice and master Python programming.
        </p>
        <button
          onClick={onStart}
          style={{
...
export default CreativeWelcomePage;
